...
texts.bg_visible(TextWindow.undocked, false)
...
function save_chat_log()
	...
	--##
	if settings.undocked_hide and texts.visible(TextWindow.main) then
		if os.clock() > docked_timer then
				TextWindow.main:hide()
		end
	end
	--##
