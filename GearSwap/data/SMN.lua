...
function job_setup()
	...
	pacts.alt8 = {
		...
		['Diabolos']='Ultimate Terror', 
		['Carbuncle']='Pacifying Ruby', 
		['Cait Sith']='Raise II',
		['Siren']='Lunatic Voice'}		
...
function check_arts() --## from WHM.lua
...
buff_spell_lists = {
	Auto = {--Options for When are: Always, Engaged, Idle, OutOfCombat, Combat
		...
		-- {Name='Reraise',	Buff='Reraise',		SpellID=113,	When='Idle'},
		...
		-- {Name='Ice Spikes',		Buff='Ice Spikes',		SpellID=??,		When='Idle'},
