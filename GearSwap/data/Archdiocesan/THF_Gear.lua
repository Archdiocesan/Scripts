...
function user_job_setup()
	...
	state.AutoSambaMode = M{['description']= 'Auto Samba Mode', 'Off', 'Haste Samba'} -- try on THF/DNC
	...
	state.TreasureMode:set('Tag') --Tag, Fulltime / gs c cycle TreasureMode
...
function init_gear_sets()
	...
	sets.TreasureHunter = set_combine(sets.TreasureHunter, {hands="PLUN. ARMLETS +1",feet="SKULKER'S POULAINES"})
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {head="PILL. BONNET +1",legs="DARRAIGNER'S BRAIS",})
    ...
    sets.midcast.FastRecast = { -- more haste, for equip haste cap
		ammo="IMPATIENS",
		neck="ORUNMILA'S TORQUE",
		ear1="LOQUAC. EARRING",
        ring1="PROLIX RING",
