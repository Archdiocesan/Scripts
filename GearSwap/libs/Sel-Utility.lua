...
function check_cleanup()
	if state.AutoCleanupMode.value then
		...
		if items.count_sack < items.max_sack then
			...
			if player.inventory['Pellucid Stone'] then send_command('put "* Stone" sack all') moveditem = true end
			if player.inventory['Taupe Stone'] then send_command('put "* Stone" sack all') moveditem = true end
			if player.inventory['Fern Stone'] then send_command('put "* Stone" sack all') moveditem = true end
			...
			if player.inventory['Alexandrite'] then send_command('put "Alexandrite" case all') moveditem = true end
			...
			if player.inventory['Lustreless Hide'] then send_command('put "Lustreless*" sack all') moveditem = true end
			if player.inventory['Lustreless Scale'] then send_command('put "Lustreless*" sack all') moveditem = true end
			if player.inventory['Lustreless Wing'] then send_command('put "Lustreless*" sack all') moveditem = true end
		...
		if not state.Capacity.value then
			...
			if player.inventory["Orichalcum Ore"] then send_command ('put "* ore" sack all') moveditem = true end
			if player.inventory["Platinum Ore"] then send_command ('put "* ore" sack all') moveditem = true end
			
			if player.inventory["Wind Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Earth Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Water Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Fire Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Ice Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Lightng. Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Light Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end
			if player.inventory["Dark Crystal"] then send_command ('put "* Crystal" sack all') moveditem = true end

			-- if player.inventory["mahogany lbr."] then send_command('put mahogany lbr. sack all') moveditem = true end
			-- if player.inventory["ebony lumber"] then send_command('put ebony lumber sack all') moveditem = true end
			-- if player.inventory["gold ingot"] then send_command('put gold ingot sack all') moveditem = true end

			if player.inventory['Mecisto. Mantle'] then send_command('put "Mecisto. Mantle" satchel') moveditem = true end
			if player.inventory['Endorsement Ring'] then send_command('put "* Ring" satchel all')  moveditem = true end
			if player.inventory['Trizek Ring'] then send_command('put "* Ring" satchel all')  moveditem = true end
			if player.inventory['Capacity Ring'] then send_command('put "* Ring" satchel all') moveditem = true end
			if player.inventory['Vocation Ring'] then send_command('put "* Ring" satchel all')  moveditem = true end
			if player.inventory['Facility Ring'] then send_command('put "* Ring" satchel all') moveditem = true end
