...
function bars.initialize(o)
	...
	o.left_cap_image = images.new({
			...
			size = {width=1,height=9},
			texture = {path=windower.addon_path.. 'bg_cap.png',fit=false},
			repeatable = {x=1,y=1},
			draggable = false
		})
	...
	-- o.name_text = texts.new('${name|(Name)}: ${hpp|(100)}%', { --###
		o.name_text = texts.new('${name|(Name)}', {

			pos = {x=0,y=0},
			text = { size=o.font_size,font=o.font,stroke={width=2,alpha=230,red=50,green=50,blue=50}},
	...
	o.action_text = texts.new('${action|(Action)}', {
			...
			flags = {bold=false,italic=true,draggable=false,right=true},
			bg = {visible=false}
		})
	...
	o.distance_text = texts.new('${dist|(0.0)}\'', {
			pos = {x=0,y=0},
			text = { size=o.font_size*0.8,font=o.font,stroke={width=2,alpha=240,red=0,green=0,blue=10}},
